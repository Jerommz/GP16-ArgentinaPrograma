...
public class Alumnos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jtID.setBorder(null);
        jPanel1.add(jtID);
        jtID.setBounds(167, 81, 24, 15);

        jdFechaNacAlumno.setBackground(new java.awt.Color(255, 255, 255));
        jdFechaNacAlumno.setDateFormatString("yyyy-MM-dd");
        jPanel1.add(jdFechaNacAlumno);
        jdFechaNacAlumno.setBounds(170, 300, 170, 22);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 22)); // NOI18N
        jLabel1.setForeground(java.awt.Color.black);
        jLabel1.setText("Alumno");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(170, 20, 72, 27);
        ...
        jtDniAlumno.setBackground(new java.awt.Color(255, 255, 255));
        jtDniAlumno.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jtDniAlumno.setForeground(new java.awt.Color(0, 0, 0));
        jtDniAlumno.setBorder(null);
        jtDniAlumno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtDniAlumnoActionPerformed(evt);
            }
        });
        jPanel1.add(jtDniAlumno);
        jtDniAlumno.setBounds(203, 81, 101, 15);

        jtNombreAlumno.setBackground(new java.awt.Color(255, 255, 255));
        jtNombreAlumno.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jtNombreAlumno.setForeground(java.awt.Color.black);
        jtNombreAlumno.setBorder(null);
        jPanel1.add(jtNombreAlumno);
        jtNombreAlumno.setBounds(173, 131, 131, 15);

        jtApellidoAlumno.setBackground(new java.awt.Color(255, 255, 255));
        jtApellidoAlumno.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jtApellidoAlumno.setForeground(java.awt.Color.black);
        jtApellidoAlumno.setBorder(null);
        jPanel1.add(jtApellidoAlumno);
        jtApellidoAlumno.setBounds(173, 194, 131, 15);

        jcbEstadoAlumno.setBackground(new java.awt.Color(255, 255, 255));
        jcbEstadoAlumno.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jcbEstadoAlumno.setForeground(java.awt.Color.black);
        jcbEstadoAlumno.setBorder(null);
        jPanel1.add(jcbEstadoAlumno);
        jcbEstadoAlumno.setBounds(173, 257, 17, 17);

        jbNuevoAlumno.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jbNuevoAlumno.setBounds(90, 380, 35, 15);

        jgModificarAlumno.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jgModificarAlumno.setBorder(null);
        ...
        jgModificarAlumno.setBounds(260, 380, 47, 15);

        jbEliminarAlumno.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jbEliminarAlumno.setBorder(null);
        ...
        jbEliminarAlumno.setBounds(170, 380, 40, 15);

        jbBuscarAlumno.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jbBuscarAlumno.setBounds(317, 77, 35, 15);
    ...
    private void jtDniAlumnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtDniAlumnoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtDniAlumnoActionPerformed
