...
public class AlumnosPorMateria extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 204, 255), 12, true));
        ...
        jcbListaMaterias.setBounds(232, 68, 161, 21);

        jtTablaAlumnoMaterias.setBackground(new java.awt.Color(204, 255, 204));
        jtTablaAlumnoMaterias.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 5, true));
        jtTablaAlumnoMaterias.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jtTablaAlumnoMaterias.setForeground(new java.awt.Color(51, 51, 51));
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(90, 20, 308, 27);
